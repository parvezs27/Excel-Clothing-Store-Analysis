...
1. Keeping documentation outside of the dashboard and not embedding it within the dashboard. Whether it's Tableau, Excel or Power BI, many times you will see the dashboard documentation such as the data source embedded within the dashboard. This is not a best practice due to several reasons. 
