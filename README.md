...
The Data Engineers for the store have provided us with the dataset for 2022 in the form of an Excel file, which we'll be using for our analysis. The dataset can be found here: [modern_traditional_data](/modern_traditional_store_dataset/).
