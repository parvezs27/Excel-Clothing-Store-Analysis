...
The Data Engineers for the store have provided us with the dataset for 2022 in the form of an Excel file, which we'll be using for our analysis. The dataset can be found here: [modern_traditional_dataset](https://github.com/parvezs27/Excel_Clothing_Store_Analysis/blob/main/modern_traditional_store_dataset.xlsx). 
